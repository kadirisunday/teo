  ...
  return (
    <div className='flex flex-col md:flex-row flx-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            <p className='text-3xl text-white md:text-4xl lg:text-5xl font-semibold leading-tight md:leading-tight lg:leading-tight'>Book Appointment<br className='hidden sm:block'/> With Trusted Doctors</p>
            <div className='flex flex-col md:flex-row items-center gap-3 text-sm font-dark'>
                <img src={assets.group_profiles} alt="" />
                <p>Simply browse through extensive list of trusted doctors, <br className='hidden sm:block'/> schedule your appointment hassle-free</p>
            </div>
